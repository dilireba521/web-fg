...
export default defineComponent({
    setup(props, ctx) {
        ...
        return () => <div class='relative h-140'>
            <img class='h-140' src={OSSURL + '/fund/home-brief.png'} alt="" onError={(e) => (e.target.src = logoImg)} />
            <div class='absolute w-full top-0'>
                <div class='container pl-15 pt-24'>
                    ...
                    <div class='font-h5 w-200 mt-8'>
                        ...
                        公司总部位于厦门，业务涵盖了证券、基金、期货、外汇和大宗商品等多个领域，为国内外企业客户、机构客户、高净值客户提供各类金融服务解决方案，公司将秉持以客户为中心，协助客户实现其资产可持续发展目标。</div>
                </div>
            </div>
        </div>
    }
