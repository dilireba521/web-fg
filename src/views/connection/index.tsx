      ...
      <div>
        ...
        <div class="w-full h-608px px-80 py-24">
          ...
          <div class="flex justify-between w-full h-50">
            <div class={`${serviceBoxClass}`} style={{ background: 'linear-gradient(180deg, #F4F9FF 0%, #EEF6FF 100%)' }}>
              <div class="font-h6 font-color-colorText mb-4">什么是合格投资者？</div>
              <div class="font-h8 font-color-colorTextSecondary">
                <div class="mb-2">根据中国证监会《私募投资基金监督管理暂行办法》及相关法规，合格投资者的认定标准为：</div>
                <div class="mb-2">1、最近3年个人年均收入≥50万元或金融资产≥300万元的个人；</div>
                <div>2、净资产≥1000万元的机构或企业。</div>
              </div>
            </div>
            <div class={`${serviceBoxClass}`} style={{ background: 'linear-gradient(180deg, #F7F8FF 0%, #EEF0FF 100%)' }}>
            ...
            <div class={`${serviceBoxClass}`} style={{ background: 'linear-gradient(180deg, #FFF8F8 0%, #FFEEEE 100%)' }}>
