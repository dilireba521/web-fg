import type { BasicColumn, BaseTableProps, CellFormat, GetColumnsParams } from '../types/type'
...
function handleActionColumn(propsRef: ComputedRef<BaseTableProps>, columns: BasicColumn[]) {
